                    ...
                    <form class="space-y-4 md:space-y-6" action="/login" method="post">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email"
                                class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('email') is-invalid @enderror"
                                placeholder="name@company.com" autofocus required="" value="{{ old('email') }}">
                            @error('email')
                                <div class="invalid-feedback text-red-600 m-1">
                                    {{ $message }}
                                </div>
                            @enderror
                        </div>
